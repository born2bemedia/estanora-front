  ...
  return [
    {
      ...
      note: t('service2_1_note', {
        fallback: 'Speak with a sustainability specialist to prioritize your efficiency upgrades.',
      }),
      price: 650,
    },
  ];
  ...
  return [
    ...
    },
    {
      ...
      description: t('orderable_service2_5_description', {
        fallback: 'Includes: Efficiency Check, Solar Assessment, Hazard Mapping, and Subsidy Scan',
      }),
      includes: true,
      price: 12000,
    },
