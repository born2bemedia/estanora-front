  ...
  return [
    {
      ...
      note: t('service3_1_note', {
        fallback: 'Strategic planning on how to unlock equity without losing financial security.',
      }),
      price: 650,
    },
  ];
  ...
  return [
    ...
    },
    {
      ...
      description: t('orderable_service3_5_description', {
        fallback: 'Includes: Equity Forecast, Annuity Scan, Lifestyle Match, and Impact Audit.',
      }),
      includes: true,
      price: 13500,
    },
