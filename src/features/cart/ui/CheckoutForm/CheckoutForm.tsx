  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className={styles.form}>
      ...
      <fieldset className={styles.fieldset}>
        ...
        <p>Bank Transfer (no other options are currently available)</p>
      </fieldset>

      <p>
        Dear user, When your order is placed, an email will be sent to you with
        payment instructions, banking details, and an overview of your order.
      </p>
      ...
      <div className={styles.checkboxes}>
        ...
        {errors.refundPolicyAccepted && (
          <span>{errors.refundPolicyAccepted.message}</span>
        )}
      </div>
