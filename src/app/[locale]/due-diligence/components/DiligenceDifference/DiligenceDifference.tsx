...
import styles from "./DiligenceDifference.module.scss";

export const DiligenceDifference = () => {
  const t = useTranslations("diligenceDifference");

  return (
    <section className={styles.diligence_difference}>
      <div className={"container"}>
        ...
        <div className={styles.diligence_difference__content}>
          <motion.div
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
            variants={fadeInUp}
            className={styles.diligence_difference__col}
          >
