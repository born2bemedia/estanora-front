...
import styles from "./PortfolioDifference.module.scss";

export const PortfolioDifference = () => {
  const t = useTranslations("portfolioServicesDifference");

  return (
    <section className={styles.portfolio_difference}>
      <div className={"container"}>
        ...
        <div className={styles.portfolio_difference__content}>
          <motion.div
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
            variants={fadeInUp}
            className={styles.portfolio_difference__col}
          >
