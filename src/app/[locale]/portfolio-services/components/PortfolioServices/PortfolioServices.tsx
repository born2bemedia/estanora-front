...
} from "@/features/services/lib/portfolio-services/first-block";
import {
  useOrderableServicesBlock2,
  usePurchasableServicesBlock2,
} from "@/features/services/lib/portfolio-services/second-block";
import {
  useOrderableServicesBlock3,
  usePurchasableServicesBlock3,
} from "@/features/services/lib/portfolio-services/third-block";
...
export const PortfolioServices = () => {
  const t = useTranslations("portfolioServicesServices");
  ...
  return (
    <section className={styles.portfolio_services}>
      <div className={"container"}>
        <motion.h2
          ...
          variants={fadeInUp}
        >
          {t("title", { fallback: "Our Portfolio Services" })}
        </motion.h2>
        <div className={styles.portfolio_services__content}>
          <ServicesWrapper
