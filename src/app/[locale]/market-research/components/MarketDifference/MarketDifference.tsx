...
import styles from "./MarketDifference.module.scss";

export const MarketDifference = () => {
  const t = useTranslations("marketResearchDifference");

  return (
    <section className={styles.market_difference}>
      <div className={"container"}>
        ...
        <div className={styles.market_difference__content}>
          <motion.div
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
            variants={fadeInUp}
            className={styles.market_difference__col}
          >
            <div className={styles.market_difference__col_item}>
              <h3>
