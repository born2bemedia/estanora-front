...
} from "@/features/services/lib/market-research/first-block";
import {
  useOrderableServicesBlock2,
  usePurchasableServicesBlock2,
} from "@/features/services/lib/market-research/second-block";
import {
  useOrderableServicesBlock3,
  usePurchasableServicesBlock3,
} from "@/features/services/lib/market-research/third-block";
...
export const MarketServices = () => {
  ...
  return (
    <section className={styles.market_services}>
      <div className={"container"}>
        <motion.h2
          ...
          variants={fadeInUp}
        >
          {t("title", { fallback: "Our Market Research Services" })}
        </motion.h2>
        <div className={styles.market_services__content}>
          <ServicesWrapper
